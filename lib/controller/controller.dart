  ...
  savedPw() {
    pwList.add(
      Todo(
        ...
        username: userInputController.text.isEmpty ? "" : userInputController.text, 
    ...
    Get.back();
    Get.snackbar(titleInputController.text, "your username ${userInputController.text} and password ${pwInputController.text} saved.");
